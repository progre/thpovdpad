...
use windows::Win32::{
    Devices::HumanInterfaceDevice::{
        IDirectInputDevice8A, IDirectInputDevice8A_Impl, IDirectInputEffect, DIACTIONFORMATA,
        DIDATAFORMAT, DIDEVCAPS, DIDEVICEIMAGEINFOHEADERA, DIDEVICEINSTANCEA, DIDEVICEOBJECTDATA,
        DIDEVICEOBJECTINSTANCEA, DIEFFECT, DIEFFECTINFOA, DIEFFESCAPE, DIFILEEFFECT, DIPROPHEADER,
        LPDIENUMCREATEDEFFECTOBJECTSCALLBACK, LPDIENUMDEVICEOBJECTSCALLBACKA,
        LPDIENUMEFFECTSCALLBACKA, LPDIENUMEFFECTSINFILECALLBACK,
    },
    Foundation::{HANDLE, HINSTANCE, HWND},
};
use windows_core::{implement, GUID, PCSTR};

use crate::direct_input_device_8_delegate::DirectInputDevice8Delegate;

#[implement(IDirectInputDevice8A)]
pub struct CustomDirectInputDevice8A {
    instance: IDirectInputDevice8A,
    delegate: DirectInputDevice8Delegate,
}

impl CustomDirectInputDevice8A {
    pub fn new(instance: IDirectInputDevice8A) -> Self {
        Self {
            instance,
            delegate: DirectInputDevice8Delegate,
        }
...
impl IDirectInputDevice8A_Impl for CustomDirectInputDevice8A_Impl {
